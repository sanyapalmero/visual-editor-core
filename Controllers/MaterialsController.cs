...
namespace CoreEditor.Controllers
{
    ...
    public class MaterialsController : Controller
    {
        ...
        public MaterialsController(CoreEditorContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,MaterialName,MaterialSize,MaterialPrice")] Material material)
        {
            if (id != material.ID)
            {
                return NotFound();
